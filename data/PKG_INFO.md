...
- 🐹 **[websocket](https://modelscope.github.io/FunASR/)**: Open-source speech recognition toolkit for training, inference, streaming ASR, VAD, punctuation, speaker diarization pipelines, and OpenAI-compatible/MCP serving.
...
- 🐹 **[qqzeng_phone_go](https://www.qqzeng.com/)**: 下一代极速 IP 定位解析引擎 (QZDB) | Next-gen High-Performance IP Lookup Engine (IPv4 & IPv6).
...
- 🐹 **[scip](https://scip-code.org)**: SCIP Code Intelligence Protocol.
- 🐹 **[vulcan-go-opensource-lib](https://github.com/github/vulcan-go-opensource-lib)**: GitHub's ops focused Elasticsearch library.
...
- 🐹 **[duckling](https://github.com/l1xnan/duckling)**: A fast viewer for CSV/Parquet files and databases such as DuckDB, SQLite, PostgreSQL, MySQL, Clickhouse, etc.
...
- 🐹 **[sympozium](https://sympozium.ai/)**: The Coordination Layer for Multi-Agent AI.
...
- 🐹 **[arex-agent-java](https://doc.arextest.com/)**: Lightweight Java agent for traffic capture and replay, enhancing testing and debugging.
...
- 🐹 **[cgo_harness](https://gotreesitter.m31labs.dev)**: Pure Go tree-sitter runtime.
...
- 🐹 **[localkms](https://sigstore.dev)**: Common go library shared across sigstore services and clients.
