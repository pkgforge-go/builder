...
- 🐹 **[onionpipe](https://github.com/cmars/onionpipe)**: Onion addresses for anything.
...
- 🐹 **[installer](https://github.com/jpillora/installer)**: One-liner for installing binaries from Github releases.
...
- 🐹 **[airtable](https://github.com/mehanizm/airtable)**: Simple golang airtable API wrapper.
...
- 🐹 **[genv](https://github.com/sakirsensoy/genv)**: Genv is a library for Go _golang_ that makes it easy to read and use environment variables in your projects.
...
- 🐹 **[spass-manager](https://github.com/0xdeb7ef/spass-manager)**: A program to decrypt .
...
- 🐹 **[committer](https://github.com/vadiminshakov/committer)**: Two-phase _2PC_ and three-phase _3PC_ protocols implementaion in Golang.
...
- 🐹 **[got](https://github.com/goradd/got)**: GoT is a template engine that turns templates into Go code to compile into your app.
...
- 🐹 **[durl](https://github.com/j3ssie/durl)**: Remove duplicate URLs by retaining only the unique combinations of hostname, path, and parameter names.
